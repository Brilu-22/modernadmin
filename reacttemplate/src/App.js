            ...
            <div class="row">
                        ...
                        <div class="row  mt-xl-0 mt-4">
                          <div class="col-md-6">
                            ...
                            <ul class="card-list mt-4">
                              <li>
                                <span class="bg-blue circle"></span>Account
                                <span>20%</span>
                              </li>
                              <li>
                                <span class="bg-success circle"></span>Services
                                <span>40%</span>
                              </li>
                              <li>
                              ...
                              <li>
                                <span class="bg-light circle"></span>Others
                                <span>15%</span>
                              </li>
                            </ul>
                          </div>
              ...
              <div class="col-xl-3 col-xxl-7">
                <div class="card">
                  ...
                  <div class="card-body">
                    <div class="user-bx">
                      <img src="assets/images/ion/man (1).png" alt="" />
                      <div>
                    ...
                    <ul class="user-list">
                      <li>
                        <img src="assets/images/ion/bussiness-man.png" alt="" />
                      </li>
                      <li>
                        <img src="assets/images/ion/hacker.png" alt="" />
                      </li>
                      <li>
                        <img src="assets/images/ion/man (2).png" alt="" />
                      </li>
                      <li>
                        <img src="assets/images/ion/woman.png" alt="" />
                      </li>
                      <li>
                        <img src="assets/images/ion/man.png" alt="" />
                      </li>
                      <li>
                        <img src="assets/images/ion/woman.png" alt="" />
                      </li>
                ...
                <div class="card">
                  ...
                  <div class="card-body">
                    ...
                    <div class="d-flex align-items-end mt-2 pb-3 justify-content-between">
                      ...
                      <span class="fs-18">
                        <span class="text-black pe-2">$1415</span>/$2000
                      </span>
                    </div>
                    ...
                    <div class="d-flex align-items-end mt-2 pb-3 justify-content-between">
                      ...
                      <span class="fs-18">
                        <span class="text-black pe-2">$1567</span>/$5000
                      </span>
                    </div>
                    <div class="progress default-progress mt-4">
                      <div
                    ...
                    <div class="d-flex align-items-end mt-2 pb-3 justify-content-between">
                      ...
                      <span class="fs-18">
                        <span class="text-black pe-2">$487</span>/$10000
                      </span>
                    </div>
                    <div class="progress default-progress mt-4">
                      <div
                    ...
                    <div class="d-flex align-items-end mt-2 justify-content-between">
                      <span>Property</span>
                      <span class="fs-18">
                        <span class="text-black pe-2">$3890</span>/$4000
                      </span>
                    </div>
                  </div>
                  <div class="card-footer border-0 pt-0">
                        ...
                        <table class="table table-responsive-md card-table transactions-table">
                          <tbody>
                            ...
                            <tr>
                              ...
                              <td>
                                <span class="text-light fs-16 font-w500 text-end d-block">
                                  Pending
                                </span>
                              </td>
                            </tr>
                            <tr>
                              ...
                              <td>
                                <span class="text-danger fs-16 font-w500 text-end d-block">
                                  Canceled
                                </span>
                              </td>
                            </tr>
                    ...
                    <div class="card progress-card">
                      <div class="card-body d-flex">
                        ...
                        <div
                          ...
                          style={{ minHeight: "110px", minWidth: "10px" }}
                        >
                          <div
